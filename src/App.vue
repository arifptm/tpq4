<template>
  <v-app>
    ...
    <v-footer fixed height="auto" class="grey darken-3">
...
export default {
  ...
  data () {
    return {      
      ...
      bottomNav: 'santri',
      items: [      
        { icon: 'person', title: 'Ustadz/ah', path: '1'},
        { icon: 'people', title: 'Santri', path: '/students'}, 
        { icon: 'school', title: 'Pendidikan', path: '3'},
        { icon: 'attach_money', title: 'Keuangan', path: '4'},        
      ],   
    }
  },
}
